...
From the Twine story list (home page), select *Import from File*, or drag and drop
the RePDO story file. Clicking on the story preview will allow you to edit it.

### Markup
For help with Twine's markup language: https://www.motoslave.net/sugarcube/2/docs/#markup
